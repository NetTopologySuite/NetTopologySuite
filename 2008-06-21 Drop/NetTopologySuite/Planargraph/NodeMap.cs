...
namespace GisSharpBlog.NetTopologySuite.Planargraph
{
                            ...
                            IComputable<Double, TCoordinate>, IConvertible
    {
        ...
        #region ICollection<KeyValuePair<TCoordinate,Node<TCoordinate>>> Members

        void ICollection<KeyValuePair<TCoordinate,Node<TCoordinate>>>.Add(KeyValuePair<TCoordinate, Node<TCoordinate>> item)
        {
        ...
        #region IEnumerable<KeyValuePair<TCoordinate,Node<TCoordinate>>> Members
