...
using NetTopologySuite.IO.TopoJSON.Converters;
using Newtonsoft.Json;
using FeatureCollectionConverter = NetTopologySuite.IO.TopoJSON.Converters.FeatureCollectionConverter;

namespace NetTopologySuite.IO.TopoJSON
{
    /// <summary>
    ...
    public class TopoJsonSerializer : JsonSerializer
    {
        ...
        public TopoJsonSerializer(IGeometryFactory factory)
        {
            ...
            base.Converters.Add(new FeatureCollectionConverter(factory));
            // TODO: envelope
        }
    }
}
