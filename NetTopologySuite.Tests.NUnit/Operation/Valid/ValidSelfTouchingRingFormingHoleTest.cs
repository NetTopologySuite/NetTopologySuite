...
namespace NetTopologySuite.Tests.NUnit.Operation.Valid
{
    ...
    public class ValidSelfTouchingRingFormingHoleTest
    {
        ...
        {
            var wkt = "POLYGON ((0 0, 0 340, 320 340, 320 0, 120 0, 180 100, 60 100, 120 0, 0 0),   (80 300, 80 180, 200 180, 200 240, 280 200, 280 280, 200 240, 200 300, 80 300))";
        ...
        {
            var wkt = "POLYGON ((0 0, 0 340, 320 340, 320 0, 120 0, 0 0),   (120 0, 180 100, 60 100, 120 0),   (80 300, 80 180, 200 180, 200 240, 200 300, 80 300),  (200 240, 280 200, 280 280, 200 240))";
            CheckIsValidSTR(wkt, true);
        ...
        {
            var wkt = "POLYGON ((0 0, 220 0, 220 200, 120 200, 140 100, 80 100, 120 200, 0 200, 0 0),   (200 80, 20 80, 120 200, 200 80))";
        ...
        {
            var wkt = "POLYGON ((40 180, 40 60, 240 60, 240 180, 140 60, 40 180))";
            CheckIsValidSTR(wkt, false);
            CheckIsValidDefault(wkt, false);
        }
        ///<summary>
        ...
        {
            var wkt = "POLYGON ((20 20, 20 100, 140 100, 140 180, 260 180, 260 100, 140 100, 140 20, 20 20))";
            CheckIsValidSTR(wkt, false);
            CheckIsValidDefault(wkt, false);
        }
        [TestAttribute]
        ...
        {
            var wkt = "POLYGON ((20 20, 120 20, 120 220, 240 220, 240 120, 20 120, 20 20))";
            CheckIsValidSTR(wkt, false);
            CheckIsValidDefault(wkt, false);
        }
        [TestAttribute]
        ...
        {
            var wkt = "POLYGON ((20 20, 120 20, 120 220, 180 220, 140 160, 200 160, 180 220, 240 220, 240 120, 20 120,  20 20))";
            CheckIsValidSTR(wkt, false);
            CheckIsValidDefault(wkt, false);
        }
