...
namespace NetTopologySuite.Tests.NUnit.Geometries.Prepared
{
    ...
    public class PreparedPointPredicateTests
    {
        ...
        public void PA_PointInInteriorOfPoly()
        {
            ...
            Assert.IsTrue(prepGeom.Intersects(geom1));
        }
        ...
        public void PA_PointOnBoundaryOfPoly()
        {
            ...
            Assert.IsFalse(prepGeom.Intersects(geom1));
        }
    ...
    public class PreparedPolygonPredicateTests
    {
        ...
        public void Test01()
        {
            ...
            Assert.IsFalse(prepGeom.Contains(geom1));
            Assert.IsFalse(prepGeom.Covers(geom1));
            Assert.IsTrue(prepGeom.Intersects(geom1));
        }
        [Test]
        ///<summary>
        ...
        public void Test02()
        {
            ...
            Assert.IsTrue(prepGeom.Contains(geom1));
            Assert.IsTrue(prepGeom.Intersects(geom1));
        }
        ...
        public void Test07()
        {
            ...
            Assert.IsTrue(prepGeom.Contains(geom1));
            Assert.IsTrue(prepGeom.Covers(geom1));
            Assert.IsTrue(prepGeom.Intersects(geom1));
        }
