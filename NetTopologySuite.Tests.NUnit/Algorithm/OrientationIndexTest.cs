    ...
    public class OrientationIndexTest
{
  ...
  public static bool IsAllOrientationsEqual(Coordinate[] pts)
  {
    ...
    orient[0] = (int)OrientationFunctions.Index(pts[0], pts[1], pts[2]);
    orient[1] = (int)OrientationFunctions.Index(pts[1], pts[2], pts[0]);
    orient[2] = (int)OrientationFunctions.Index(pts[2], pts[0], pts[1]);
