...
namespace GisSharpBlog.NetTopologySuite.Samples.Tests.Various
{
    ...
    {
        private IPolygon polygon1;
        private IPolygon polygon2;
        ...
        private void createCoordinates(ref ICoordinate[] array1, ref ICoordinate[] array2)
        {
            BufferedCoordinate2DFactory coordFactory = new BufferedCoordinate2DFactory();

            array1 = new ICoordinate[]  {   coordFactory.Create(10, 10), 
                                            coordFactory.Create(50, 10),
                                            coordFactory.Create(50, 50),
                                            coordFactory.Create(10, 50),
                                            coordFactory.Create(10, 10), };

            array2 = new ICoordinate[]  {   coordFactory.Create(11, 11), 
