...
namespace NetTopologySuite.Algorithm.Locate
{
    ...
    /// </summary>
    /// <remarks>
    ///     The algorithm used is only guaranteed to return correct results for points which are <b>not</b> on the
    ...
    public class SimplePointInAreaLocator : IPointOnGeometryLocator
    {
        ...
        /// <summary>
        ///     Determines the <see cref="Location" /> of a point in an areal <see cref="IGeometry" />. Currently this will never
        ///     return a value of <see cref="Location.Boundary" />.
        /// </summary>
