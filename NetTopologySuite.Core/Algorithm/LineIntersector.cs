...
namespace NetTopologySuite.Algorithm
{
    ...
    ///             <item>
    ///                 <see cref="CollinearIntersection" /> - the segments are collinear and they intersect in a line
    ///                 segment
    ///             </item>
    ///         </list>
    ///     </para>
    ...
    public abstract class LineIntersector
    {
        ...
        [Obsolete("Ambiguous naming, use NoIntersection")] public const int DontIntersect = 0;

        [Obsolete("Ambiguous naming, use PointIntersection")] public const int DoIntersect = 1;

        [Obsolete("Ambiguous naming, use CollinearIntersection")] public const int Collinear = 2;
