...
namespace NetTopologySuite.Algorithm
{
    ...
    /// </summary>
    /// <remarks>
    ///     A <see cref="IBoundaryNodeRule" /> may be specified to control the evaluation of whether the point lies on the
    ///     boundary or not
    ...
    ///         <list Type="Bullet">
    ///             <item>
    ///                 <see cref="ILinearRing" />s do not enclose any area - points inside the ring are still in the
