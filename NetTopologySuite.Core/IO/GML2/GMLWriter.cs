...
namespace NetTopologySuite.IO.GML2
{
    ...
    ///     <remarks>
    ///         Thanks to <see href="http//www.codeplex.com/Wiki/View.aspx?ProjectName=MsSqlSpatial">rstuven</see> for
    ///         improvements :)
    ///     </remarks>
    /// </summary>
    public class GMLWriter
    {
        ...
        public XmlReader Write(IGeometry geometry)
        {
            ...
            var reader = XmlReader.Create(outStream);
            return reader;
        }
        ...
        protected void Write(Coordinate coordinate, XmlWriter writer)
        {
            ...
            writer.WriteElementString(GMLElements.gmlPrefix, "X", GMLElements.gmlNS,
                coordinate.X.ToString("g", NumberFormatter));
            writer.WriteElementString(GMLElements.gmlPrefix, "Y", GMLElements.gmlNS,
                coordinate.Y.ToString("g", NumberFormatter));
            writer.WriteEndElement();
        }
