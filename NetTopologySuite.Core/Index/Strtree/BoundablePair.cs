...
{
    /// <summary>
    ///     A pair of <see cref="IBoundable{T,TItem}" />s, whose leaf items
    ...
    internal class BoundablePair<TItem> : IComparable<BoundablePair<TItem>>
    {
        ...
        /// <summary>
        ///     Creates an instance of this class with the given <see cref="IBoundable{Envelope, TItem}" />s and the
        ///     <see cref="IItemDistance{Envelope, TItem}" /> function.
        /// </summary>
        ...
        public BoundablePair(IBoundable<Envelope, TItem> boundable1, IBoundable<Envelope, TItem> boundable2,
            IItemDistance<Envelope, TItem> itemDistance)
        {
        ...
        */
        ...
        ///     <see cref="IItemDistance{Envelope, TItem}.Distance(IBoundable{Envelope, TItem}, IBoundable{Envelope, TItem})" />.
        /// </summary>
