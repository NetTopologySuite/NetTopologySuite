...
namespace NetTopologySuite.Index.Strtree
{
    ...
    ///     P. Rigaux, Michel Scholl and Agnes Voisard.
    ///     <i>
    ...
    ///     <para>
    ///         This implementation is based on <see cref="IBoundable{T,TItem}" />s rather than just
    ///         <see cref="AbstractNode{T, TItem}" />s,
        ...
        where T : IIntersectable<T>, IExpandable<T>
    {
        ...
        protected virtual IList<IBoundable<T, TItem>> CreateParentBoundables(
            IList<IBoundable<T, TItem>> childBoundables, int newLevel)
        {
        ...
        {
            Assert.IsTrue(!(_built || _building),
        ...
        private static void BoundablesAtLevel(int level, AbstractNode<T, TItem> top,
            ICollection<IBoundable<T, TItem>> boundables)
        {
