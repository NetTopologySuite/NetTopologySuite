...
namespace NetTopologySuite.Index.Strtree
{
    ...
    public class STRtree<TItem> : AbstractSTRtree<Envelope, TItem>, ISpatialIndex<TItem>
    {
        ...
        protected override IList<IBoundable<Envelope, TItem>> CreateParentBoundables(
            IList<IBoundable<Envelope, TItem>> childBoundables, int newLevel)
        {
        ...
        /// <param name="newLevel"></param>
        /// <returns></returns>
        private List<IBoundable<Envelope, TItem>> CreateParentBoundablesFromVerticalSlices(
            IList<IBoundable<Envelope, TItem>>[] verticalSlices, int newLevel)
        {
        ...
        /// <param name="newLevel"></param>
        /// <returns></returns>
        protected IList<IBoundable<Envelope, TItem>> CreateParentBoundablesFromVerticalSlice(
            IList<IBoundable<Envelope, TItem>> childBoundables, int newLevel)
        {
        ...
        protected IList<IBoundable<Envelope, TItem>>[] VerticalSlices(
            IList<IBoundable<Envelope, TItem>> childBoundables, int sliceCount)
        {
