namespace NetTopologySuite.Index.Bintree
{
    ...
    public class Interval
    {
        ...
        /// <summary>
        ///     Creates a new interval instance, setting <see cref="Min" />=<paramref name="min" /> and <see cref="Max" />=
        ///     <paramref name="max" />;
        /// </summary>
        ...
        /// <summary>
        ///     Creates a new interval instance, setting <see cref="Min" />=<paramref name="interval.Min" /> and <see cref="Max" />
        ///     =<paramref name="interval.Max" />.
        /// </summary>
        ...
        /// <summary>
        ///     Function to test if this <see cref="Interval" /> overlaps the interval R[<paramref name="min" />,
        ///     <paramref name="max" />].
        /// </summary>
        ...
        /// <summary>
        ///     Function to test if this <see cref="Interval" /> contains the interval R[<paramref name="min" />,
        ///     <paramref name="max" />].
        /// </summary>
