...
namespace NetTopologySuite.Index.Chain
{
    ...
    ///     </para>
    ///     <para>
    ///         Property 2 allows an efficient
    ...
    ///         <list type="Table">
    ///             <item>Envelope select</item>
    ///             <description>
    ///                 determine all the segments in the chain which
    ///                 intersect a given envelope.
    ///             </description>
    ///             <item>Overlap</item>
    ///             <description>
    ///                 determine all the pairs of segments in two chains whose
    ///                 envelopes overlap.
    ///             </description>
    ///         </list>
    ///     </para>
 ...
 */
        ...
        private void ComputeOverlaps(int start0, int end0, MonotoneChain mc, int start1, int end1,
