...
namespace NetTopologySuite.Operation.Overlay
{
    ...
    public class PolygonBuilder
    {
        ...
        /// <returns></returns>
        private List<EdgeRing> BuildMinimalEdgeRings(List<EdgeRing> maxEdgeRings, IList<EdgeRing> shellList,
            IList<EdgeRing> freeHoleList)
        {
        ...
        /// </summary>
        /// <returns>
        ///     The shell EdgeRing, if there is one<br /> or
        ///     <value>null</value>
        ///     , if all the rings are holes.
        /// </returns>
        ...
        /// <param name="shellList"></param>
        /// <param name="freeHoleList"></param>
        private static void SortShellsAndHoles(IEnumerable<EdgeRing> edgeRings, IList<EdgeRing> shellList,
            IList<EdgeRing> freeHoleList)
        {
        ...
        /// <param name="shellList"></param>
        /// <returns>
        ///     Containing EdgeRing, if there is one <br /> or
        ///     <value>null</value>
