...
namespace NetTopologySuite.Operation.Buffer
{
    ...
    ///             <li>
    ///                 <see cref="EndCapStyle.Square" /> - end caps are squared off at the buffer distance beyond the line
    ///                 ends
    ///             </li>
    ///         </ul>
    ///     </para>
    ...
    ///             <li>
    ///                 <see cref="JoinStyle.Mitre" /> - corners are "sharp" (up to a
    ///                 <see cref="IBufferParameters.MitreLimit" /> distance limit})
    ///             </li>
    ...
    public class BufferOp
    {
        ...
        ///     The styles supported are <see cref="GeoAPI.Operations.Buffer.BufferStyle.CapRound" />,
        ///     <see cref="GeoAPI.Operations.Buffer.BufferStyle.CapButt" />, and
        ///     <see cref="GeoAPI.Operations.Buffer.BufferStyle.CapSquare" />.
