...
namespace NetTopologySuite.Operation.Buffer
{
    ...
    public class BufferParameters : IBufferParameters
    {
        ...
        ///     <list type="Table">
        ///         <item><c>QuadrantSegments</c> &gt;>= 1</item>
        ///         <description>
        ///             joins are round, and <c>QuadrantSegments</c> indicates the number of segments to use to
        ///             approximate a quarter-circle.
        ///         </description>
        ///         <item><c>QuadrantSegments</c> = 0</item><description>joins are beveled</description>
        ///         <item><c>QuadrantSegments</c> &lt; 0</item>
        ///         <description>
        ///             joins are mitred, and the value of qs indicates the mitre ration limit as
        ///             <c>mitreLimit = |<tt>QuadrantSegments</tt>|</c>
        ///         </description>
        ///     </list>
        ...
        /// <remarks>
        ///     <para>
        ///         Allowable values are <see cref="GeoAPI.Operations.Buffer.JoinStyle.Round" /> (which is the default),
        ///         <see cref="GeoAPI.Operations.Buffer.JoinStyle.Mitre" /> and
        ///         <see cref="GeoAPI.Operations.Buffer.JoinStyle.Bevel" />
        ///     </para>
        /// </remarks>
