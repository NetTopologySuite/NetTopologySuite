...
{
    /// <summary>
    ///     Unions a <c>Collection</c> of <see cref="IGeometry" />s or a single Geometry (which may be a
    ///     <see cref="IGeometryCollection" />) together.
    /// </summary>
    /// <remarks>
    ///     <para>
    ...
    ///         <list type="Bullet">
    ///             <item>
    ///                 Unioning a set of <see cref="IPolygon" />s has the effect of merging the areas (i.e. the same effect
    ///                 as iteratively unioning all individual polygons together).
    ///             </item>
    ///             <item>
    ///                 Unioning a set of <see cref="ILineString" />s has the effect of <b>fully noding</b>
    ...
    ///                 If <b>merged</b> linework is required, the <see cref="LineMerger" /> class can be used.
    ///             </item>
    ///             <item>
    ///                 Unioning a set of <see cref="IPoint" />s has the effect of merging all identical points (producing a
    ...
    public class UnaryUnionOp
    {
        ...
        ///     or <c>null</c> if the input is empty
        /// </returns>
        ...
        /// <param name="geom">A geometry to union</param>
        /// <returns>
        ///     The union of the elements of the geometry
        ///     or an empty GEOMETRYCOLLECTION
        /// </returns>
        ...
        /// </summary>
        /// <remarks>
        ///     Due to the way the overlay operations are implemented, this is still efficient in the case of linear and puntal
        ///     geometries.
        /// </remarks>
