...
namespace NetTopologySuite.Operation.Polygonize
{
    ...
    public class Polygonizer
    {
        ...
        /// <summary>
        ///     Creates a polygonizer and allow specifyng if only polygons which form a valid polygonal geometry are to be
        ///     extracted.
        /// </summary>
        /// <param name="extractOnlyPolygonal">
        ///     <value>true</value>
        ///     if only polygons which form a valid polygonal geometry are to be extracted
        /// </param>
        ...
        private static void FindValidRings(IEnumerable<EdgeRing> edgeRingList, ICollection<EdgeRing> validEdgeRingList,
            ICollection<IGeometry> invalidRingList)
        {
        ...
        private static void AssignHoleToShell(EdgeRing holeEdgeRing, IList<EdgeRing> shellList)
        {
            ...
            if (shell != null) shell.AddHole(holeEdgeRing);
        }
