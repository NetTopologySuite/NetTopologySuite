...
namespace NetTopologySuite.Operation
{
    ...
    ///     <list type="Bullet">
    ///         <item>
    ///             Valid <see cref="IPolygonal" /> geometries are simple by definition, so
    ...
    ///             use <see cref="NetTopologySuite.Geometries.Geometry.IsValid()" />).
    ///         </item>
    ///         <item>
    ///             <b>
    ///                 <see cref="ILineal" />
    ///             </b>
    ///             geometries are simple if and only if they do <i>not</i> self-intersect at interior points
    ...
    ///         </item>
    ///         <item>
    ///             <b>Zero-dimensional (<see cref="IPuntal" />)</b> geometries are simple if and only if they have no
    ///             repeated points.
    ///         </item>
