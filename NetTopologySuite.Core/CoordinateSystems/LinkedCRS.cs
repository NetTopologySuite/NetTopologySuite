...
namespace NetTopologySuite.CoordinateSystems
{
    ...
    public class LinkedCRS : CRSBase
    {
        ...
        /// </summary>
        /// <param name="href">
        ///     The mandatory <see href="http://geojson.org/geojson-spec.html#linked-crs">href</see> member must be
        ///     a dereferenceable URI.
        /// </param>
        /// <param name="type">
        ///     The optional type member will be put in the properties Dictionary as specified in the
        ///     <see href="http://geojson.org/geojson-spec.html#linked-crs">GeoJSON spec</see>.
        /// </param>
