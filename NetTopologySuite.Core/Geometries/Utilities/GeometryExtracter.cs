...
namespace NetTopologySuite.Geometries.Utilities
{
    ...
    public static class GeometryExtracter
    {
        ...
        /// <summary>
        ///     Extracts the <c>T</c> components from an <see cref="IGeometry" /> and adds them to the provided
        ///     <see cref="List{T}" />.
        /// </summary>
        ...
        /// <summary>
        ///     Extracts the <code>T</code> elements from a single <see cref="IGeometry" /> and returns them in a
        ///     <see cref="List{T}" />.
        /// </summary>
        /// <param name="geom">the geometry from which to extract</param>
