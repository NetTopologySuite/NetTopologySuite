...
namespace NetTopologySuite.Geometries.Utilities
{
    ...
    public class PointExtracter : IGeometryFilter
    {
        ...
        /// <summary>
        ///     Extracts the <see cref="IPoint" /> elements from a single <see cref="IGeometry" /> and adds them to the provided
        ///     <see cref="IList{IPoint}" />.
        /// </summary>
        ...
        /// <summary>
        ///     Extracts the <see cref="IPoint" /> elements from a single <see cref="IGeometry" /> and returns them in a
        ///     <see cref="IList{IPoint}" />.
        /// </summary>
        /// <param name="geom">the geometry from which to extract</param>
