...
namespace NetTopologySuite.Geometries.Utilities
{
    ...
    public class PolygonExtracter : IGeometryFilter
    {
        ...
        /// <summary>
        ///     Extracts the <see cref="IPolygon" /> elements from a single <see cref="IGeometry" /> and adds them to the provided
        ///     <see cref="IList{IPolygon}" />.
        /// </summary>
        ...
        /// <summary>
        ///     Extracts the <see cref="IPolygon" /> elements from a single <see cref="IGeometry" /> and returns them in a
        ///     <see cref="IList{IPolygon}" />.
        /// </summary>
        /// <param name="geom">The geometry from which to extract</param>
