...
namespace NetTopologySuite.Geometries
{
    ...
    public class GeometryFactory : IGeometryFactory
    {
        ...
        ///             <li>
        ///                 a rectangle returns a <see cref="IPolygon" /> whose points are (minx, maxy), (minx, maxy), (maxx,
        ///                 maxy), (maxx, miny).
        ///             </li>
        ///         </ul>
        ///     </para>
        ...
        /// <returns>
        ///     An empty <c>Point</c> (for null <c>Envelope</c>s), a <c>Point</c> (when min x = max x and min y = max y) or a
