...
namespace NetTopologySuite.Geometries
{
    ...
    public abstract class Geometry : IGeometry
    {
        /// <summary>
        /// </summary>
        private static readonly Type[] _sortedClasses =
        {
            typeof(Point),
            typeof(MultiPoint),
            typeof(LineString),
        ...
        /// <summary>
        ///     A predefined <see cref="GeometryFactory" /> with <see cref="PrecisionModel" /> <c> == </c>
        ///     <see cref="PrecisionModels.Fixed" />.
        /// </summary>
        ...
        public int SRID
        {
            ...
            set
            {
                ...
                Factory = GeometryServiceProvider.Instance.CreateGeometryFactory(
        ...
        /// </summary>
        /// <remarks>
        ///     The returned coordinate should not be assumed to be an actual Coordinate object used in the internal
        ///     representation.
        /// </remarks>
        /// <returns>a Coordinate which is a vertex of this <c>Geometry</c>.</returns>
        /// <returns>
        ///     <c>null</c> if this Geometry is empty.
        /// </returns>
        ...
        ///         <item>
        ///             The DE-9IM Intersection Matrix for the two geometries matches<br />
        ///             <c>[T********]</c> or<br />
        ///             <c>[*T*******]</c> or<br />
        ///             <c>[***T*****]</c> or<br />
        ///             <c>[****T****]</c>
        ///         </item>
        ///         <item>
        ///             <c>!g.disjoint(this)</c><br />
        ///             (<c>Intersects</c> is the inverse of <c>Disjoint</c>)
        ///         </item>
        ///     </list>
        /// </remarks>
        /// <param name="g">The <c>Geometry</c> with which to compare this <c>Geometry</c>.</param>
        ...
        ///             <list type="Table">
        ///                 <listheader>
        ///                     <item>Code</item><description>Description</description>
        ///                 </listheader>
        ///                 <item>
        ///                     <c>[T*T******]</c>
        ///                 </item>
        ///                 <description>for P/L, P/A, and L/A situations</description>
        ///                 <item>
        ///                     <c>[T*****T**]</c>
        ///                 </item>
        ///                 <description>for L/P, A/P, and A/L situations)</description>
        ///                 <item>
        ///                     <c>[0********]</c>
        ///                 </item>
        ///                 <description>for L/L situations</description>
        ///             </list>
        ///         </item>
        ///     </list>
        ...
        ///         In other words, if a geometry A is a subset of the points in the boundary of a geometry B,
        ///         <c>A.within(B) == false</c>
        ...
        ///         </item>
        ///         <item>
        ///             <c>g.within(this)</c><br />
        ///             (<c>Contains</c> is the converse of <see cref="Within" />)
        ///         </item>
        ///     </list>
        ///     <para>
   ...
   * (or equivalently neither covers the other),
        ...
        ///     <list type="Bullet">
        ///         <item>
        ///             The geometries have at least one point each not shared by the other (or equivalently neither covers the
        ///             other),
        ...
        ///         </item>
        ///         <item>
        ///             <c>g.CoveredBy(this) == true</c><br />
        ///             (<c>covers</c> is the converse of <see cref="CoveredBy" />)
        ///         </item>
        ///     </list>
        ...
        ///     intersection matrix for the two <c>Geometry</c>s
        /// </param>
        /// <returns>
        ///     <c>true</c> if the DE-9IM intersection
        ///     matrix for the two <c>Geometry</c>s match <c>intersectionPattern</c>
        /// </returns>
        ...
        ///     </para>
        ///     <para>
        ///         The <c>EndCapStyle</c> property of the <c>bufferParameters</c> argument specifies the buffer geometry that will
        ///         be
        ///         created at the ends of linestrings.  The styles provided are:
        ///         <ul>
        ///             <li><see cref="EndCapStyle.Round" /> - (default) a semi-circle</li>
        ...
        ///     <c>PrecisionModel</c> of the <c>Geometry</c>.
        /// </param>
        /// <param name="bufferParameters">
        ///     This argument type has a number of properties that control the construction of the
        ///     buffer, including <c>QuadrantSegments</c>, <c>EndCapStyle</c>, <c>JoinStyle</c>, and <c>MitreLimit</c>
        /// </param>
        /// <returns>
        ///     a polygonal geometry representing the buffer region (which may be empty)
        /// </returns>
        ...
        /// <returns>
        ///     A point-set combining the points of this <c>Geometry</c> and the
        ///     points of <c>other</c>
        /// </returns>
        ...
        /// </summary>
        /// <remarks>
        ///     This method supports <see cref="IGeometryCollection" />s (which the other overlay operations currently do not).
        /// </remarks>
        /// <remarks>
        ...
        ///         <item>
        ///             Unioning a set of <see cref="IPolygon" />s always returns a <see cref="IPolygonal" /> geometry
        ...
        /// </summary>
        /// <param name="other">
        ///     The <c>Geometry</c> with which to compare this <c>Geometry</c>
        ...
        /// <summary>
        ///     Returns whether this <c>Geometry</c> is greater than, equal to,
        ///     or less than another <c>Geometry</c>, using the given <see paramref="IComparer{ICoordinateSequence}" />.
        /// </summary>
        /// <remarks>
        ///     If their classes are different, they are compared using the following
        ///     ordering:
        ...
        private static bool IsNonHomogenousGeometryCollection(IGeometry g)
        {
            return
                ...
                (g.GeometryType == "GeometryCollection");
            ; /*g.GetType().Name == "GeometryCollection" && g.GetType().Namespace == GetType().Namespace;*/
        }
