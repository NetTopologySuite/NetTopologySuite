...
namespace NetTopologySuite.Geometries
{
    ...
    ///             (i.e. does not have an <c>NaN</c> X- or Y-ordinate
    ///         </item>
    ///     </list>
    /// </summary>
    public class Point : Geometry, IPoint
    {
        ...
        public Point(Coordinate coordinate) :
            this(GeometryFactory.Default.CoordinateSequenceFactory.Create(new[] {coordinate}),
        ...
        /// <summary>
        /// </summary>
        public override Coordinate[] Coordinates => IsEmpty ? new Coordinate[] {} : new[] {Coordinate};
