...
{
    /// <summary>
    ///     Computes the <c>Covers</c> spatial relationship predicate for a <see cref="PreparedPolygon" /> relative to all
    ///     other <see cref="IGeometry" /> classes.
    /// </summary>
    /// <remarks>
    ///     Uses short-circuit tests and indexing to improve performance.
    ///     <para>
    ///         It is not possible to short-circuit in all cases, in particular in the case where the test geometry touches the
    ///         polygon linework.
