...
{
    /// <summary>
    ///     Computes the <c>contains</c> spatial relationship predicate for a <see cref="PreparedPolygon" /> relative to all
    ...
    internal class PreparedPolygonContains : AbstractPreparedPolygonContains
    {
        ...
        /// <summary>
        ///     Computes the <c>contains</c> spatial relationship predicate between a <see cref="PreparedPolygon" /> and a
        ///     <see cref="IGeometry" />.
        /// </summary>
