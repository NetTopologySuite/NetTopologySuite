...
{
    /// <summary>
    ///     Computes the <c>containsProperly</c> spatial relationship predicate for <see cref="PreparedPolygon" />s relative to
    ///     all other {@link Geometry} classes.<br />
    ...
    internal class PreparedPolygonContainsProperly : PreparedPolygonPredicate
    {
        ...
        /// <summary>
        ///     Computes the <c>containsProperly</c> predicate between a <see cref="PreparedPolygon" /> and a
        ///     <see cref="IGeometry" />.
        /// </summary>
