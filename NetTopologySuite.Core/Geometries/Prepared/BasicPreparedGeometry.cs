...
namespace NetTopologySuite.Geometries.Prepared
{
    ...
    /// <remarks>
    ///     <para>
    ///         Contains default implementations for methods, which simply delegate to the equivalent
    ///         <see cref="IGeometry" /> methods.
    ///     </para>
    ///     <para>
    ///         This class may be used as a "no-op" class for Geometry types which do not have a corresponding
    ///         <see cref="IPreparedGeometry" /> implementation.
    ///     </para>
    /// </remarks>
