...
namespace RTools_NTS.Util
{
    ...
    public class SoftwarePackage
    {
        ...
        public Boolean Uninstall(Boolean interactive)
        {
            Process p = null;
        ...
        /// or not.</param>
        /// <returns>Boolean - true for 1 or more found and uninstalled, false
        /// otherwise.</returns>
        public static Boolean UninstallMultiple(string productName, Boolean interactive)
        {
            SoftwarePackage[] setups = GetList();
            foreach (SoftwarePackage s in setups)
            {
