...
namespace RTools_NTS.Util
{
    ...
    public abstract class Token
    {
        ...
        /// <returns>Boolean - true for equals, false otherwise.</returns>
    ...
    public class FloatToken : Token
    {
        ...
        public override string ToDebugString()
        {
            ...
            {
                return (String.Format("FloatToken: null"));
            }
        }
    ...
    public class IntToken : Token
    {
        ...
        public static IntToken ParseHex(string s, Int32 lineNumber)
        {
            IntToken it = null;
            try
            {
