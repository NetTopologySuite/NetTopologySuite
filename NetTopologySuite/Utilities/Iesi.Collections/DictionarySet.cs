...
namespace Iesi_NTS.Collections
{
    ...
    public abstract class DictionarySet : Set
    {
        ...
        public override Boolean AddAll(ICollection c)
        {
        ...
        public override Boolean ContainsAll(ICollection c)
        {
            foreach (object o in c)
            {
                if (!Contains(o))
        ...
        public override Boolean RemoveAll(ICollection c)
        {
            Boolean changed = false;
            foreach (object o in c)
            {
        ...
        public override Boolean RetainAll(ICollection c)
        {
