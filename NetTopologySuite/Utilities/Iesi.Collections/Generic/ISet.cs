...
namespace Iesi_NTS.Collections.Generic
{
    ...
    public interface ISet<T> : ICollection<T>, ICloneable
    {
        ...
        Boolean ContainsAll(ICollection<T> c);
        ...
        Boolean AddAll(ICollection<T> c);
        ...
        Boolean RemoveAll(ICollection<T> c);
        ...
        Boolean RetainAll(ICollection<T> c);
