...
namespace Iesi_NTS.Collections.Generic
{
    ...
    public abstract class DictionarySet<T> : Set<T>
    {
        ...
        public override Boolean AddAll(ICollection<T> c)
        {
        ...
        public override Boolean ContainsAll(ICollection<T> c)
        {
            foreach (T o in c)
            {
                if (! Contains(o))
        ...
        public override Boolean RemoveAll(ICollection<T> c)
        {
            Boolean changed = false;
            foreach (T o in c)
            {
        ...
        public override Boolean RetainAll(ICollection<T> c)
        {
