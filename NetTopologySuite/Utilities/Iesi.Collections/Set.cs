...
namespace Iesi_NTS.Collections
{
    ...
    public abstract class Set : ISet
    {
        ...
        public abstract Boolean AddAll(ICollection c);
        ...
        public abstract Boolean ContainsAll(ICollection c);
        ...
        public abstract Boolean RemoveAll(ICollection c);
        ...
        public abstract Boolean RetainAll(ICollection c);
