...
namespace GisSharpBlog.NetTopologySuite.Algorithm
{
    ...
    public class RobustLineIntersector : LineIntersector
    {
        ...
        public override Int32 ComputeIntersect(ICoordinate p1, ICoordinate p2, ICoordinate q1, ICoordinate q2)
        {
            isProper = false;

            // first try a fast test to see if the envelopes of the lines intersect
            if (!Extents.Intersects(p1, p2, q1, q2))
            {
            ...
            Int32 Pq1 = CGAlgorithms.OrientationIndex(p1, p2, q1);
            Int32 Pq2 = CGAlgorithms.OrientationIndex(p1, p2, q2);
            ...
            Int32 Qp1 = CGAlgorithms.OrientationIndex(q1, q2, p1);
            Int32 Qp2 = CGAlgorithms.OrientationIndex(q1, q2, p2);
        ...
        private Int32 ComputeCollinearIntersection(ICoordinate p1, ICoordinate p2, ICoordinate q1, ICoordinate q2)
        {
            Boolean p1q1p2 = Extents.Intersects(p1, p2, q1);
            Boolean p1q2p2 = Extents.Intersects(p1, p2, q2);
            Boolean q1p1q2 = Extents.Intersects(q1, q2, p1);
            Boolean q1p2q2 = Extents.Intersects(q1, q2, p2);
        ...
        private void NormalizeToMinimum(ICoordinate n1, ICoordinate n2, ICoordinate n3, ICoordinate n4,
                                        ICoordinate normPt)
        {
        ...
        /// lies at the origin.
        /// </summary>
        private void NormalizeToEnvCentre(ICoordinate n00, ICoordinate n01, ICoordinate n10, ICoordinate n11,
                                          ICoordinate normPt)
        {
        ...
        private Boolean IsInSegmentEnvelopes(ICoordinate intPt)
        {
            IExtents env0 = new Extents(inputLines[0, 0], inputLines[0, 1]);
            IExtents env1 = new Extents(inputLines[1, 0], inputLines[1, 1]);
