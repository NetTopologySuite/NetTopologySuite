namespace NetTopologySuite.Algorithm
{
    ...
    public abstract class LineIntersector
    {
        ...
        public Coordinate GetEndpoint(int segmentIndex, int ptIndex) => InputLines[segmentIndex][ptIndex];
        ...
        public Coordinate GetIntersection(int intIndex) => IntersectionPoint[intIndex];
