...
{
    /// <summary>
    /// Computes the intersections between two line segments in <c>SegmentString</c>s
    /// and adds them to each string.
    /// The <c>SegmentIntersector</c> is passed to a <c>Noder</c>.
    /// The AddIntersections method is called whenever the <c>Noder</c>
    ...
    public class SegmentIntersector
    {
        ...
        /// of the <c>SegmentIntersector</c> class to process
