...
namespace NetTopologySuite.Noding
{
    ...
    /// </summary>
    public class NodedSegmentString<TCoordinate> : INodableSegmentString<TCoordinate>, IList<LineSegment<TCoordinate>>
            ...
            IComputable<Double, TCoordinate>, IConvertible
    {
        ...
        private readonly SegmentNodeList<TCoordinate> _nodeList;
        ...
        {
            get { return Slice.GetFirst(_coordinates).Equals(Slice.GetLast(_coordinates)); }
        }

        #region IList<LineSegment<TCoordinate>> Members

        public Int32 Count
        {
            get { return _coordinates.Count; /*jd: was _coordinates.TotalItemCount -1; */ }
        }
