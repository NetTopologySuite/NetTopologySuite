...
namespace GisSharpBlog.NetTopologySuite.Operation.Buffer
{
    ...
    {        
        ...
        private void AddPolygon(Polygon p)
        {
            ...
            Coordinate[] shellCoord = CoordinateArrays.RemoveRepeatedPoints(shell.Coordinates);
            ...
            for (int i = 0; i < p.NumInteriorRings; i++)
            {
                ...
                Coordinate[] holeCoord = CoordinateArrays.RemoveRepeatedPoints(hole.Coordinates);
