...
namespace GisSharpBlog.NetTopologySuite.Operation.Buffer
{
    ...
    /// </remarks>
    public class BufferBuilderForLineString<TCoordinate>
                            ...
                            IComputable<Double, TCoordinate>
    {
        ...
        /// </param>
        public BufferBuilderForLineString(IGeometryFactory<TCoordinate> geoFactory)
        {
        ...
        /// </returns>
        public IGeometry<TCoordinate> Buffer(ILineString<TCoordinate> g, Double distanceForth, Double distanceBack)
        {
            ...
            OffsetCurveBuilderForLineString<TCoordinate> curveBuilder
                = new OffsetCurveBuilderForLineString<TCoordinate>(_geoFactory, 
                                                      precisionModel, 
                                                      _quadrantSegments);

            curveBuilder.EndCapStyle = _endCapStyle;

            OffsetCurveSetBuilderForLineString<TCoordinate> curveSetBuilder
                = new OffsetCurveSetBuilderForLineString<TCoordinate>(g, distanceForth, distanceBack, curveBuilder);
