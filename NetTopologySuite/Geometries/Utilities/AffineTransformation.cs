 ...
 *
 */
public class AffineTransformation : ICloneable, ICoordinateSequenceFilter
{
  ...
  */
  ...
  {
      double xp = m00 * seq.GetOrdinate(i, Ordinates.X) + m01 * seq.GetOrdinate(i, Ordinates.Y) + m02;
      double yp = m10 * seq.GetOrdinate(i, Ordinates.X) + m11 * seq.GetOrdinate(i, Ordinates.Y) + m12;
