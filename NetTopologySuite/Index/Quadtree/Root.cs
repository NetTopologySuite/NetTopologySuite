...
namespace GisSharpBlog.NetTopologySuite.Index.Quadtree
{
    ...
    public class Root : NodeBase
    {
        ...
        {
            Int32 index = GetSubnodeIndex(itemEnv, origin);
        ...
        /// </summary>
        private void InsertContained(Node tree, IExtents itemEnv, object item)
        {
            ...
            */
            Boolean isZeroX = IntervalSize.IsZeroWidth(itemEnv.MinX, itemEnv.MaxX);
            Boolean isZeroY = IntervalSize.IsZeroWidth(itemEnv.MinX, itemEnv.MaxX);
            NodeBase node;
            if (isZeroX || isZeroY)
            {
