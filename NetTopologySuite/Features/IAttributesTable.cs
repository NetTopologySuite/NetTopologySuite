...
namespace NetTopologySuite.Features
{
    ...
    {
        /// <summary>
        /// Method to add the attribute &qout;<paramref name="attributeName"/>&qout; from the attribute table.
        /// </summary>
        ...
        /// <summary>
        /// Method to delete the attribute &qout;<paramref name="attributeName"/>&qout; from the attribute table.
        /// </summary>
        /// <param name="attributeName">The name (or key) of the attribute</param>
        void DeleteAttribute(string attributeName);

        /// <summary>
        /// Function to query the <see cref="System.Type"/> of the Attribute &qout;<paramref name="attributeName"/>&qout;
        /// </summary>
        /// <param name="attributeName">The name (or key) of the attribute</param>
