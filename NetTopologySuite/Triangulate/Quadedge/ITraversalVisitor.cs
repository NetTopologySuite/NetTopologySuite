...
namespace GisSharpBlog.NetTopologySuite.Triangulate.Quadedge
{
        ...
        ///<summary>
        /// Interface for classes which process triangles visited during travesals of a <see cref="QuadEdgeSubdivision{TCoordinate}"/>
        ///</summary>
        ///<typeparam name="TCoordinate"></typeparam>
        public interface ITraversalVisitor<TCoordinate>
        where TCoordinate : ICoordinate<TCoordinate>, IEquatable<TCoordinate>, IComparable<TCoordinate>,
                            IComputable<Double, TCoordinate>, IConvertible
        {
            ///<summary>
            /// Visits a triangle during a traversal of a <see cref="QuadEdgeSubdivision{TCoordinate}"/>. An implementation of
            ...
            Boolean Visit(QuadEdgeTriangle<TCoordinate> currTri, int edgeIndex, QuadEdgeTriangle<TCoordinate> neighbTri);
        }
