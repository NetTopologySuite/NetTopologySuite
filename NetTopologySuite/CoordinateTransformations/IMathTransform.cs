...
namespace GisSharpBlog.NetTopologySuite.CoordinateTransformations
{
	...
	public interface IMathTransform
	{
		...
		/// </remarks>
		/// <param name="ord">Packed ordinates of points used to generate convex hull.</param>
		DomainFlags GetDomainFlags(double[] ord);
		...
		/// <param name="cp"> Point to transform.</param>
		CoordinatePoint Transform(CoordinatePoint cp);
		...
		/// </remarks>
		/// <param name="ord">Packed ordinates of points to transform.</param>
		...
		/// </remarks>
		/// <param name="cp">Point in domain at which to get derivative.</param>
		Matrix Derivative(CoordinatePoint cp);
