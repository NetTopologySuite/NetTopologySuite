...
namespace NetTopologySuite.IO.Tests.GeoJSON
{
    ...
    public class GeoJsonSerializerTest
    {
        ...
        /// <summary>
        /// Same test as <see cref="GeoJsonDeserializeIssue176"/>, ok
        /// using <see cref="GeoJsonSerializer.Create()"/>
        /// </summary>
        [Test]
        public void GeoJsonDeserializeOkUsingGeoJsonSerializerCreate()
        {
            Exception ex = null;
            try
            {
                TestIssue176(GeoJsonSerializer.Create());
            }
