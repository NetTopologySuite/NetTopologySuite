...
namespace NetTopologySuite.Tests.NUnit.Performance.Index
{
    ...
    public class STRtreePerfTest : PerformanceTestCase
    {
        private const int NODE_SIZE = 32;
        private const int ITEM_ENV_SIZE = 10;
        private const int QUERY_ENV_SIZE = 40;

        private STRtree<object> _index;

        public STRtreePerfTest() : base(nameof(STRtreePerfTest))
        {
        ...
        {
            PerformanceTestRunner.Run(typeof(STRtreePerfTest));
        }
