...
namespace NetTopologySuite.Tests.NUnit.Operation.Distance
{
    ...
    public abstract class BaseDistanceTest : GeometryTestCase
    {
        ...
        [TestCase("POLYGON ((76 185, 125 283, 331 276, 324 122, 177 70, 184 155, 69 123, 76 185), (267 237, 148 248, 135 185, 223 189, 251 151, 286 183, 267 237))",
            "LINESTRING (153 204, 185 224, 209 207, 238 222, 254 186)", 13.788860460124573, 139.4956500724988, 206.78661188980183, 153, 204, false)]
        [TestCase("POLYGON ((76 185, 125 283, 331 276, 324 122, 177 70, 184 155, 69 123, 76 185), (267 237, 148 248, 135 185, 223 189, 251 151, 286 183, 267 237))",
            "LINESTRING (120 215, 185 224, 209 207, 238 222, 254 186)", 0, 120, 215, 120, 215, true)]
        ...
        {
            TestClosestPoints("LINESTRING (100 100, 200 200)", "LINESTRING (150 121, 200 0)", 20.506096654409877, 135.5, 135.5, 150, 121, false);
        }
    }
