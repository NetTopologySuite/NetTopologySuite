...
namespace NetTopologySuite.Tests.NUnit.Operation.Buffer
{
    ...
    public class BufferTest : GeometryTestCase
    {
        ...
        [Test,
         Ignore(
             "This test needs to be investigated in JTS to see why the result is failing.  The expectation is that the buffer is empty, but it isn't")]
        ...
        [Test,
         Ignore(
             "This test needs to be investigated in JTS to see why the result is failing.  The expectation is that there are no holes in the buffer, but there are")]
        ...
        public void TestPolygonMultipleHoles()
        {
            new BufferValidator(
                ...
                .TestBufferHolesExpected(true)
                .TestEmptyBufferExpected(false)
                .SetPrecisionModel(new PrecisionModel(PrecisionModels.Floating))
                .TestContains();
        }
        ...
        public void Test33()
        {
            ...
            // PrecisionModel(PrecisionModels.FloatingSingle), "MULTIPOLYGON
            // (((708258.754920656
        ...
        {
            var a = Read("POLYGON((0 0, 100 0, 100 100, 0 100, 0 0))");
            var b = Read("POLYGON((50 50, 150 50, 150 150, 50 150, 50 50))");
            var polygons = new[] {a, b};
            var polygonCollection = GeometryFactory.Default.CreateGeometryCollection(polygons);
            var union = polygonCollection.Buffer(0);
            Assert.That(union.ToString(),
                Is.EqualTo("POLYGON ((0 0, 0 100, 50 100, 50 150, 150 150, 150 50, 100 50, 100 0, 0 0))"));
        }
        ...
        {
            var a = Read("POLYGON ((10 10, 50 10, 25 35, 35 35, 10 10))");
            var result = a.Buffer(0);
            var expected = Read("POLYGON ((10 10, 30 30, 50 10, 10 10))");
        ...
        {
            var a = Read("POLYGON ((0 40, 60 40, 60 0, 0 0, 0 40), (10 10, 50 10, 25 35, 35 35, 10 10))");
            var result = a.Buffer(0);
            var expected = Read("POLYGON ((0 40, 60 40, 60 0, 0 0, 0 40), (10 10, 50 10, 30 30, 10 10))");
            CheckEqual(expected, result);
        }
       ...
       */
        ...
        {
            const string wkt = "LINESTRING (25 44, 31 44, 32 38, 29 37, 25 37, 25 38, 24 40, 24 44, 25 44)";
            CheckBuffer(wkt, 100,
