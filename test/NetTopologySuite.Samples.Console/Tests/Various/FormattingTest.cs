...
namespace NetTopologySuite.Samples.Tests.Various
{
    ...
    public class FormattingTest : BaseSamples
    {
        ...
        public void FloatFormatting17DigitsTest1()
        {
            ...
            var test = (Point)new WKTReader().Read(point.ToString());
        ...
        public void FloatFormatting9MoreDigitsTest2()
        {
            ...
            var test = (Point)new WKTReader(new NtsGeometryServices(new PrecisionModel(PrecisionModels.FloatingSingle))).Read(point.ToString());
            Debug.WriteLine(point.ToString());
            Debug.WriteLine(test.ToString());
        ...
        public void FloatFormatting9MoreDigitsTest3()
        {
            ...
            var test = (Point)new WKTReader(new NtsGeometryServices(new PrecisionModel(PrecisionModels.Fixed))).Read(point.ToString());
            Debug.WriteLine(point.ToString());
            Debug.WriteLine(test.ToString());
