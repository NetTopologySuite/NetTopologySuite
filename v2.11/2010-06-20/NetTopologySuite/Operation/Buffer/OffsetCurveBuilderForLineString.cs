...
namespace GisSharpBlog.NetTopologySuite.Operation.Buffer
{
    ...
    /// </summary>
    public class OffsetCurveBuilderForLineString<TCoordinate>
            ...
            IComputable<Double, TCoordinate>, IConvertible
    {
        ...
        */
        ...
        private Double _distanceForth, _distanceBack, _distance;
        private readonly IPrecisionModel<TCoordinate> _precisionModel;
        private BufferStyle _endCapStyle = BufferStyle.Butt;
        ...
        public OffsetCurveBuilderForLineString(IGeometryFactory<TCoordinate> geoFactory, Int32 quadrantSegments)
            : this(geoFactory, geoFactory.PrecisionModel, quadrantSegments) { }

        public OffsetCurveBuilderForLineString(IGeometryFactory<TCoordinate> geoFactory, 
        ...
        public IEnumerable<ICoordinateSequence<TCoordinate>> GetLineCurve(IEnumerable<TCoordinate> inputPts, Double distanceForth, Double distanceBack)
        {
            // a zero or negative width buffer of a line/point is empty
            if (distanceBack <= 0.0d && distanceForth <= 0.0d)
            {
                yield break;
            }

            init(distanceForth, distanceBack);
        ...
        private void init(Double distanceForth, Double distanceBack)
        {
