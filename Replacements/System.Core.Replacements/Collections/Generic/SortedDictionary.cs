...
namespace System.Collections.Generic
{
    ...
    public class SortedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>
    {
        ...
        object IDictionary.this[object key]
        {
            ...
            set
            {
                ...
                try
                {
                    ...
                    {
                        throw new ArgumentException(string.Format("Wrong type: {0}/{1}", value, typeof(TValue)), "value");
                    }
                }
                catch (InvalidCastException)
                {
                    throw new ArgumentException(string.Format("Wrong type: {0}/{1}", key, typeof(TKey)), "key");
                }
            }
        }
        ...
        public sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
        {
            ...
            void ICollection.CopyTo(Array array, int index)
            {
                ...
                {
                    throw new ArgumentException("Lower bound != 0.");
                }

                if (index < 0)
                {
                    throw new ArgumentOutOfRangeException("arrayIndex", "Need non-negative index.");
                }
            ...
            {
                throw new NotSupportedException("Not supported in KeyCollectionSet.");
            }
        ...
        public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
        {
            ...
            public void CopyTo(TValue[] array, int index)
            {
                ...
                if (array.Length - index < Count)
                {
                    throw new ArgumentException("Array plus offset to small");
                }
    ...
    internal sealed class TreeSet<T> : SortedSet<T>
    {
        ...
        internal override bool AddIfNotPresent(T item)
        {
            ...
            if (!ret)
            {
                throw new ArgumentException(string.Format("Adding duplicate: {0}", item));
            }
            return ret;
        }
    }
