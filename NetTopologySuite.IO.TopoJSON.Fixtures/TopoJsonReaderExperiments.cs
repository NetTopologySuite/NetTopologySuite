...
namespace NetTopologySuite.IO.TopoJSON.Fixtures
{
    ...
    /// </summary>
    [TestFixture]
    public class TopoJsonReaderExperiments
    {
        ...
        public void read_reference_data()
        {
            ...
            TestTransformer transformer = new TestTransformer(obj.arcs, Factory);
        ...
        public void read_quantized_data()
        {
            ...
            TestTransformer transformer = new TestTransformer(transform, obj.arcs, Factory);
