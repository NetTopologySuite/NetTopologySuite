...
using NetTopologySuite.IO.TopoJSON.Helpers;
...
namespace NetTopologySuite.IO.TopoJSON.Fixtures
{
    public class TestTransformer
    {
        ...
        public TestTransformer(double[][][] arcs) :
            this(arcs, DefaultFactory) { }

        public TestTransformer(double[][][] arcs, IGeometryFactory factory) :
            this(new Transform(), arcs, factory) { }

        public TestTransformer(ITransform transform, double[][][] arcs) :
            this(transform, arcs, DefaultFactory) { }

        public TestTransformer(ITransform transform, double[][][] arcs, IGeometryFactory factory)
        {
            if (transform == null)
